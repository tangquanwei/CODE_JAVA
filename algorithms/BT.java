...
public class BT {
    ...
    class Solution {
        ...
        public TreeNode buildTree(int[] inorder, int[] postorder) {
            ...
            preorder[0] = postorder[postorder.length];
            for (int i = 0; i < postorder.length - 1; i++)
                preorder[i + 1] = postorder[i];
        ...
        private TreeNode build(int[] preorder, int[] inorder, int preLeft, int preRight, int inLeft, int inRight) {
            ...
            int lsize = index - inLeft;
            // recursive
            root.left = build(preorder, inorder, preLeft + 1, preLeft + lsize, inLeft, index - 1);
            root.right = build(preorder, inorder, preLeft + lsize + 1, preRight, index + 1, inRight);
            return root;
        }
    }
}
